...
Encoding=UTF-8
Name=BlakeBitcoin
Comment=BlakeBitcoin P2P Cryptocurrency
Comment[fr]=BlakeBitcoin, monnaie virtuelle cryptographique pair à pair
Comment[tr]=BlakeBitcoin, eşten eşe kriptografik sanal para birimi
Exec=blakebitcoin-qt %u
Terminal=false
Type=Application
Icon=bitcoin128
MimeType=x-scheme-handler/blakebitcoin;

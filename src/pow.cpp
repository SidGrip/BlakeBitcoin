...
// BEGIN BLAKEBITCOIN: preserve the original retarget rules from the 0.8.x tree
// Retarget every 8064 blocks (14 days at 150-second spacing)
// Use the full-interval lookback after height 150000 and clamp to 25%-400%.

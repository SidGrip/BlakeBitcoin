...
#if QT_CONFIG(tooltip)
        messageTextLabel->setToolTip(QCoreApplication::translate("SendCoinsEntry", "A message that was attached to the blakebitcoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the network.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)

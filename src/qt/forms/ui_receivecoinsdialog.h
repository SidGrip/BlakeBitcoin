...
public:
    ...
    void setupUi(QWidget *ReceiveCoinsDialog)
    {
        ...
        label_addressType = new QLabel(frame2);
        label_addressType->setObjectName(QString::fromUtf8("label_addressType"));
        label_addressType->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout->addWidget(label_addressType, 5, 0, 1, 1);

        addressType = new QComboBox(frame2);
        addressType->addItem(QString());
        addressType->addItem(QString());
        addressType->addItem(QString());
        addressType->setObjectName(QString::fromUtf8("addressType"));

        gridLayout->addWidget(addressType, 5, 2, 1, 1);
        ...
        label_addressType->setBuddy(addressType);
...
#if QT_CONFIG(tooltip)
        label_addressType->setToolTip(QCoreApplication::translate("ReceiveCoinsDialog", "Select which address format to generate for this request.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_addressType->setText(QCoreApplication::translate("ReceiveCoinsDialog", "Address &type:", nullptr));
        addressType->setItemText(0, QCoreApplication::translate("ReceiveCoinsDialog", "Legacy", nullptr));
        addressType->setItemText(1, QCoreApplication::translate("ReceiveCoinsDialog", "P2SH-SegWit", nullptr));
        addressType->setItemText(2, QCoreApplication::translate("ReceiveCoinsDialog", "Bech32", nullptr));

#if QT_CONFIG(tooltip)
        addressType->setToolTip(QCoreApplication::translate("ReceiveCoinsDialog", "Select which address format to generate for this request.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        label_3->setToolTip(QCoreApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the network.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_3->setText(QCoreApplication::translate("ReceiveCoinsDialog", "&Message:", nullptr));
#if QT_CONFIG(tooltip)
        reqMessage->setToolTip(QCoreApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the network.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)

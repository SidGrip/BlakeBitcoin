...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BlakeBitcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BlakeBitcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/BlakeBitcoin/BlakeBitcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BlakeBitcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BlakeBitcoin Core 0.15.21"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blakebitcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/BlakeBitcoin/BlakeBitcoin"

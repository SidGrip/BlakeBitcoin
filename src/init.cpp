...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BlakeBitcoin/BlakeBitcoin>";
    const std::string URL_WEBSITE = "<https://github.com/BlakeBitcoin/BlakeBitcoin>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BlakeBitcoin version %s\n", FormatFullVersion());
}
